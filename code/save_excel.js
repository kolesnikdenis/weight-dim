...
var obj_shipment1={};
var res;
function save_excel1(file_json,res1) {
    cell=1;
	res=res1;
...
function add_cell_weight(in_obj,callback) {
    ...
    callback(null, out.text);
}
function add_cell_weight1(){
    console.log('add_cell_weight1 start');
    //var result = wait.for(add_cell_weight,obj_shipment1);
}
function create_excel(load_goods_chicken,obj_shipment) {
    ...
    console.log("do:"+cell);
    //wait.launchFiber(add_cell_weight1);
    console.log("posle:"+cell);
    worksheet.cell(cell, 6).string("Итого:");
    cell++;
    console.log("posle+1:"+cell);
